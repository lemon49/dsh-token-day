window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function ModelTable({ models, query, onQueryChange, t }) {
			const normalized = query.trim().toLocaleLowerCase();
			const filtered = (0, react.useMemo)(() => {
				if (normalized.length === 0) return models;
				return models.filter((model) => model.model.toLocaleLowerCase().includes(normalized) || model.provider.toLocaleLowerCase().includes(normalized));
			}, [models, normalized]);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: t("modelBreakdown") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
						type: "search",
						value: query,
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("table", {
						...
						] }) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: filtered.map((model) => {
		...
		function TokensChart({ records, t }) {
			...
			const barWidth = Math.min(46, Math.max(3, column * .62));
			const axisTicks = [
				0,
				.5,
				1
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TokenUsageSection_module_css_default.blockHead,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: t("tokensChart") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("tokensChartIntro") })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
							className: TokenUsageSection_module_css_default.chartTotal,
							title: formatTokens(total),
							children: formatCompactTokens(total)
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", {
									...
									children: [
										...
										index % labelEvery === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
											...
											textAnchor: "middle",
											className: TokenUsageSection_module_css_default.chartAxisLabel,
											children: slice.date.slice(5)
										}) : null,
										hover ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("g", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("rect", {
											x: padLeft + column * index,
											y: padTop,
											width: column,
											height: plotHeight,
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: slice.date }),
		...
		function TokenUsageSection({ useSessions, t }) {
			...
			const coverage = period.requests === 0 ? void 0 : period.billed / period.requests;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("header", {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						"aria-label": t("rangeDays", { count: range }),
						children: [
							7,
							30,
							90
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Metric, {
								label: t("coverage"),
								value: coverage === void 0 ? "—" : formatPercent(coverage)
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Metric, {
								label: t("activeDays"),
								value: `${period.activeDays}/${range}`
							})
						]
					}),
