window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var TokenUsageSection_module_css_default = {
			"activityWeekday": "K0x3wW_activityWeekday",
			...
			"activityMatrix": "K0x3wW_activityMatrix",
			...
			"activityMonth": "K0x3wW_activityMonth",
			...
			"activityFooter": "K0x3wW_activityFooter",
		...
		function activityCalendar(span, days, now = Date.now()) {
		...
		function ActivityHeatmap({ span, onSpanChange, days, t }) {
			const calendar = (0, react.useMemo)(() => activityCalendar(span, days), [span, days]);
			const weeks = Math.max(1, Math.ceil(calendar.length / 7));
			const monthFormatter = (0, react.useMemo)(() => new Intl.DateTimeFormat(void 0, { month: "short" }), []);
			const monthAt = (week) => {
				const cell = calendar[week * 7];
				if (cell === void 0 || cell.empty || cell.date === "") return void 0;
				return monthFormatter.format(/* @__PURE__ */ new Date(`${cell.date}T00:00:00.000Z`));
			};
			const renderCell = (cell, key) => {
				if (cell.empty) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: t("activity") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: t("activityIntro") })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								children: value === 365 ? t("heatYear") : value === 180 ? t("heatHalfYear") : t("heatRangeDays", { count: value })
							}, value))
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: TokenUsageSection_module_css_default.activityMatrix,
						style: { gridTemplateColumns: `26px repeat(${weeks}, minmax(0, 1fr))` },
						role: "grid",
						"aria-label": t("activity"),
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { className: TokenUsageSection_module_css_default.activityGutter }),
							Array.from({ length: weeks }, (_, week) => {
								const label = monthAt(week);
								const previous = week > 0 ? monthAt(week - 1) : void 0;
								return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: TokenUsageSection_module_css_default.activityMonth,
									children: label !== void 0 && label !== previous ? label : ""
								}, `month-${week}`);
							}),
							weekdays.map((weekday, row) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: TokenUsageSection_module_css_default.activityWeekday,
								children: row % 2 === 0 ? weekday : ""
							}), Array.from({ length: weeks }, (_, week) => renderCell(calendar[week * 7 + row], `${week}-${row}`))] }, weekday))
						]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: TokenUsageSection_module_css_default.activityFooter,
		...
		function TokenUsageSection({ useSessions, t }) {
			...
			const [heatSpan, setHeatSpan] = (0, react.useState)(365);
		...
		const en = {
			...
			heatRangeDays: "Last {count} days",
			heatHalfYear: "Last 6 months",
			heatYear: "Last 1 year",
