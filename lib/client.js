window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function activityCalendar(dates, days, now = Date.now()) {
		...
		function ActivityHeatmap({ dates, days, t }) {
			const calendar = (0, react.useMemo)(() => activityCalendar(dates, days), [dates, days]);
