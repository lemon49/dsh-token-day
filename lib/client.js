	...
	factory: (require) => {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: groups.active.map((summary) => {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("count", { count: groups.archived.length }) }),
									groups.archived.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										className: SessionManagerSection_module_css_default.exportButton,
										onClick: exportArchivedIds,
										title: t("copyAllIdsTitle"),
										children: exported ? t("copied") : t("copyAllIds")
									}) : null
								]
								...
								className: SessionManagerSection_module_css_default.list,
								children: groups.archived.map((summary) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SessionRow, {
									summary,
		...
		*/
		...
		const managerZh = {
			nav: "对话管理",
			title: "对话管理",
			intro: "查看 DSH 会话与归档：左侧为全部会话，右侧为归档会话（含 DSH 内置归档）。可复制单个会话 id，或一键导出归档 id 列表（换行分隔）供本地删除。",
			refresh: "刷新",
			conversations: "对话管理",
			archived: "归档管理",
			count: "共 {count} 个",
		...
		const managerEn = {
			...
			intro: "View DSH sessions and archives: the left column lists every session, the right column lists archived ones (including DSH-native archives). Copy a single session id, or export the full archived-id list (newline-separated) for local deletion.",
			refresh: "Refresh",
